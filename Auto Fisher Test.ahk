...
;Pixel location of interact prompt (multiply by resolution)811, 755 1894, 1159
BaseX1 := 0.316
BaseX2 := 0.739
BaseY1 := 0.524
BaseY2 := 0.804
...
locationY1 := round(mathy1)
locationY2 := round(mathy2)
Return
...
loop
	{
	PixelSearch, x, y, locationX1, locationY1, locationX2, locationY2, 0xffffff,, Fast
	found := !ErrorLevel
	If !found
	sleep 100
	}
...
loop
	{
	PixelSearch, x, y, locationX1, locationY1, locationX2, locationY2, 0x333333,, Fast
	found := !ErrorLevel
	If !found
	sleep 100
	}
